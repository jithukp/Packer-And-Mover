...
public class view_worker_more extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_worker_more);
        ...
        tv1.setText(sh.getString("wname", ""));
        tv2.setText(sh.getString("wplace", ""));
        tv3.setText(sh.getString("wdistrict", ""));
        tv4.setText(sh.getString("wphone", ""));

        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String wno=ed.getText().toString();
                if(wno.equalsIgnoreCase("")||wno.equalsIgnoreCase("0")){
                    ed.setError("Invalid number");
                } else{
                    sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                    ip=sh.getString("url","");
                    url=ip+"and_send_request";
...
//                params.put("w", sh.getString("ww",""));
                            ...
                            params.put("wid",sh.getString("worker_id",""));
                            params.put("reqid", sh.getString("rid",""));
                            params.put("wno", wno);
