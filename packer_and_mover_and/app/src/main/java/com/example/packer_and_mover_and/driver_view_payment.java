...
public class driver_view_payment extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_view_payment);
        lv=findViewById(R.id.lv);

        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        ip=sh.getString("url","");
        url=ip+"driver_view_payment";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lv.setAdapter(new custom_payment(getApplicationContext(),date, name, amount, phone));//custom_view_service.xml and li is the listview object
